...
| :--- | :--- | :--- |
| **Rudraksh Sharma** | 2401010395 | RAG System, SHAP Explainability, XGBoost Modeling, Model Evaluation, Retrieval Pipeline, FAISS Vector Store, LangGraph, LangChain |
| **Bineet Keshari** | 2401010130 | Feature Contribution Analysis, LangGraph Node Design, Prompt Engineering |
| **Vridhi Chaudhary** | 2401010336 | Knowledge Base Curation, Embedding Pipeline, Groq LLM Integration |
| **Anshuman Mehta** | 2401010082 | System Architecture, Frontend Dashboard (Streamlit), Deployment Setup |
